...
function renderEditorialHeader(e,{home=false}={}) {
 ...
 return `<header class="he-header"><div class="he-wrap he-nav"><a class="he-brand" href="/" aria-label="${e(brand.name)} 메인"><strong>${e(brand.name)}</strong><small>${e(brand.englishName)}</small></a><nav class="he-desktop-nav" aria-label="주요 메뉴">${nav}</nav><a class="he-header-cta" href="${prefix}#consultation">상담 신청 ${arrow}</a><details class="he-mobile-menu"><summary>메뉴 <span aria-hidden="true">＋</span></summary><nav aria-label="모바일 주요 메뉴">${nav}</nav></details></div></header>`;
}
